<html>
  ...
  <body>
    ...
    <p> <strong>Ghidra Project Directory:</strong> The directory to your Ghidra Project Folder. This needs to be created in Ghidra GUI before this script can be ran.</p>
   ...
   <h2>Output</h2>
   <p> Your decompiled output will be stored in a folder in the same level as the executable. It will store it in a folder starting with src_Ghidra. Currently, DragonBreath does not look for and clean up this folder before running, meaning if you want rerun DragonBreath on an executable, you'll have to decide whether or not to delete all of the files from the first run.</p>
  </body>
